class ProductsController < ApplicationController
  ...
  def index
    @products = Product.order("existingline, updated_at desc, created_at desc, active").page(params[:page]).per(50)
  end
  ...
  def show
    ...
    @brands = Brand.active_brands.order("created_at DESC").limit(4)
  end
